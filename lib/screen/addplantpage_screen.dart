...
class _AddPlantPageState extends State<AddPlantPage>
  ...
  // ฟังก์ชันตรวจสอบความยาวชื่อต้นไม้
  String? validatePlantName(String? value) {
    if (value == null || value.isEmpty) {
      return "กรุณากรอกชื่อต้นไม้";
    }
    if (value.trim().length > 15) {
      return "ชื่อต้นไม้ต้องไม่เกิน 15 ตัวอักษร";
    }
    if (value.trim().length < 2) {
      return "ชื่อต้นไม้ต้องมีอย่างน้อย 2 ตัวอักษร";
    }
    return null;
  }
  ...
  // เพิ่มฟังก์ชันสร้าง Dropdown สำหรับเซ็นเซอร์
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        maxLength: 15, // จำกัดความยาวสูงสุด
                                        decoration: buildInputDecoration().copyWith(
                                          ...
                                          helperText:
                                              'ความยาว 2-15 ตัวอักษร', // เพิ่มข้อความช่วย
                                        ...
                                        validator:
                                            validatePlantName, // ใช้ฟังก์ชันใหม่
                                      ),
